...
if __name__ == '__main__':
    ...
    noisy = False
    out_root_path = f'./numerical_results/PT&GP_comparison/{num_features}feature'
    if not os.path.exists(out_root_path):
        os.makedirs(out_root_path)

    out_path = f'{out_root_path}/simple_regret_{objective_function}_noisy{noisy}_total{iter_num}_init{n_init}_repeat{repeat_num}.xlsx'
